...
class Student:
    def __init__(self, nnname, hhhouse):
        ...
        # Test wpisany powyżej w __init__ działa tylko przy utworzeniu obiektu.
    ...
    def house(self):
        ...
        return self._house
        # Używamy tu _house z podkreśleniem. Nie można mieć tej samej nazwy house
        # dla zmiennej instancji i dla funkcji. To kolizja. Funkcja wywoływałaby samą siebie.
...
def main():
    ...
    # Zaletą settera jest fakt, że deweloper może pisać, jakby klasycznie ustawiał
    # wartość zmiennej, podczas gdy faktycznie jego polecenie przechodzi przez setter
    # i zawarte w nim mechanizmy sprawdzające.
    # Setter sprawdzi zarówno input od użytkownika, jak i wywołania z kodu; wszystko.

    # Żeby nadpisać wartość deweloper musiałby odnieść się do wewnętrznej zmiennej
    # (z podkreśleniem) i napisać: student._house = "Hufflepuff".
    # Konwencja jest taka, że podkreślenie w Pythonie oznacza "nie ruszać".
